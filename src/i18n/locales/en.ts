export const en = {
  ...
  health: {
    ...
    symptoms: {
      ...
      freeDescriptionPlaceholder1: "Even if it's just a little discomfort, tell me.",
      freeDescriptionPlaceholder2: "What's bothering you today?",
      freeDescriptionPlaceholder3: 'Describe your symptoms freely...',
      uploadMedicalRecord: 'Upload Medical Record/Prescription',
      uploadMedicalRecordLabel: 'Upload Medical Record',
      uploadedMedicalRecords: 'Uploaded Medical Records',
  ...
  nutrition: {
    ledgerPrompt:
      "I've organized these nutrition records for you. Which part would you like to check first?",
    viewTimeline: 'View Timeline',
    record: {
    ...
    reflection: {
      prompt:
        "As your nutritionist, I want to understand every detail of your meals today. Tell me what you ate, and I'll help you analyze the nutritional balance to ensure your diet is healthy and well-balanced.",
      ...
      detailTitle: 'Food Reflection Detail',
      ...
      suggestions: 'Suggestions',
      suitability: 'Suitability',
      pendingAnalysis: 'Waiting for analysis...',
      analyzing: 'Analyzing...',
      analysisFailed: 'Analysis failed',
