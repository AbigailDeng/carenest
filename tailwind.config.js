  ...
  theme: {
    extend: {
      colors: {
        ...
        // Soft dreamy color scheme (FR-031C)
        dreamy: {
      ...
      fontFamily: {
        ...
        body: ['Montserrat', 'PingFang SC', 'PingFang Light', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
        light: ['Montserrat', 'PingFang SC', 'PingFang Light', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
      },
      borderRadius: {
